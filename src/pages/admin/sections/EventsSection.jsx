...
const glassSelectClass = `w-full px-4 py-3 bg-black/40 backdrop-blur-md border border-white/20 rounded-xl text-white font-medium 
  focus:border-gt-gold focus:outline-none hover:bg-black/50 transition-all
  [&>option]:bg-gray-900 [&>option]:text-white [&>option:checked]:bg-gt-gold/20`;
